...
function(caffe_prebuild_macros_py output_dir)
    add_custom_command(
        ...
        COMMAND ${Caffe_SCRIPT_DIR}/prebuild/macros.py ${output_dir}
...
function(caffe_prebuild_layer_creator_py output_dir)
	add_custom_command(
	    COMMAND ${CMAKE_COMMAND} -E make_directory "${output_dir}"
		COMMAND ${Caffe_SCRIPT_DIR}/prebuild/layer_creator.py ${output_dir}
...
function(caffe_prebuild_blob_creator_py output_dir)
	add_custom_command(
	    COMMAND ${CMAKE_COMMAND} -E make_directory "${output_dir}"
		COMMAND ${Caffe_SCRIPT_DIR}/prebuild/blob_creator.py ${output_dir}
...
function(caffe_prebuild_quantizer_creator_py output_dir)
	add_custom_command(
	    COMMAND ${CMAKE_COMMAND} -E make_directory "${output_dir}"
		COMMAND ${Caffe_SCRIPT_DIR}/prebuild/quantizer_creator.py ${output_dir}
...
function(caffe_prebuild_test_macros_py output_dir)
	add_custom_command(
	    COMMAND ${CMAKE_COMMAND} -E make_directory "${output_dir}"
		COMMAND ${Caffe_SCRIPT_DIR}/prebuild/test_macros.py ${output_dir}
...
function(caffe_cuda_nvrtc_header_loader_py output_dir header_files compiler standard_include_names header_exclude_names)
	add_custom_command(
	    COMMAND ${CMAKE_COMMAND} -E make_directory "${output_dir}"
		COMMAND ${Caffe_SCRIPT_DIR}/prebuild/cuda_nvrtc_header_loader.py
